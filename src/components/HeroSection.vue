                ...
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            Hi guys 👋,
                            <br />
                            I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500">
                                Duc Anh
                            </span>😁
                        </h1>
                    </div>
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        ...
                        <br />
                        📫 Feel free to reach me out <a href="mailto:tducanh263@gmail.com" class="text-[#abcdef]">tducanh263@gmail.com</a>
                        <br />
                        💬 Github url: <a href="https://github.com/ducanhduocdochu" class="text-[#abcdef]">https://github.com/ducanhduocdochu</a>
                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        <button
                            ...
                            <a href="mailto:tducanh263@gmail.com">
                        ...
                        <button
                            ...
                            <div
                                ...
                                <a href="/Tran-Duc-Anh-Web-Developer.pdf" download="Tran-Duc-Anh-Web-Developer.pdf"
                                    class="pl-2 text-primary"> Download cv</a>
                            </div>
                        </button>
                    </div>
                </div>
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            ...
                            <img src="https://avatars.githubusercontent.com/u/100296074?v=4" alt="Hero pic" width="500" height="auto" loading="lazy"
